...
['EPSILON', 'ERROR_TYPE', 'FOMA_TYPE', 'HFST2_TYPE', 'HFST_OLW_TYPE', 'HFST_OL_TYPE', 
 'HfstBasicTransducer', 'HfstBasicTransition', 'HfstFile', 'HfstInputStream', 'HfstOutputStream', 
 ...
 'get_output_to_console', 'hfst_open', 'hfst_stdin', 'hfst_stdout', 'intersect', 'is_diacritic', 
